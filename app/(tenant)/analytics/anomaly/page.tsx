  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-400">AI 기반 전력 사용 패턴 이상 감지 및 분석</p>
      </div>
      ...
      <div className="mb-8 grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-gradient-to-br from-yellow-800 to-yellow-900 p-6 rounded-lg">
          <div className="flex items-center justify-between mb-2">
            <span className="text-gray-300">높음 이상</span>
            <Zap className="w-5 h-5 text-yellow-400" />
          </div>
          <div className="text-3xl font-bold">{highAnomalies.length}</div>
          <div className="text-sm text-gray-400 mt-2">주시 필요</div>
        </div>
      </div>
      ...
      <div className="bg-gray-800 rounded-lg p-6">
        ...
        {anomalies.length === 0 ? (
          <div className="text-center py-12">
            <div className="text-gray-400 text-lg">정상 범위의 데이터입니다</div>
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-3 gap-4 text-sm">
                      <div>
                        <span className="text-gray-400">전력값</span>
                        <div className="font-semibold">{anom.value.toFixed(1)} kW</div>
                      </div>
                      <div>
                        <span className="text-gray-400">이상 점수</span>
                        <div className="font-semibold">{anom.score.toFixed(3)}</div>
                      </div>
                      <div>
                        <span className="text-gray-400">권장 조치</span>
      ...
      {isLoading && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center rounded">
          <div className="flex flex-col items-center gap-3">
            ...
            <p className="text-gray-300">이상 탐지 중입니다...</p>
          </div>
        </div>
      )}
    </div>
