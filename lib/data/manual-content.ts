  ...
  chapters: [
    ...
    // ══════════════════════════════════════════════
    {
      ...
      articles: [
        ...
        },
        {
          id: 'plans',
          title: '구독 플랜 안내',
          description: 'Trial·Starter·Business·Enterprise 플랜 차이와 선택 기준을 설명합니다.',
          body: [
            {
              type: 'p',
              text: '탄소이음은 "기능이 아니라 절감 효과를 파는" ROI 기반 가격 정책을 채택합니다. 플랜 비용은 에너지 절감으로 첫 달에 회수되도록 설계되었습니다.',
            },
            {
              type: 'roles',
              items: [
                { role: 'Trial (무료)', desc: '30일 체험. IoT 하드웨어 미지원. 고지서 업로드·수동 입력으로 에너지 데이터 체험. 사이트 1개, 디바이스 10개, 사용자 2명.' },
                { role: 'Starter (₩99,000/월)', desc: '소규모 사업장 IoT 연동. 디바이스 최대 20개, 사이트 1개, 사용자 5명, 90일 데이터 보존. 연간 ₩990,000(2개월 무료). 절감액 ≥ ₩300,000/월 예상.' },
                { role: 'Business (₩299,000/월)', desc: '중소기업 표준. 디바이스 최대 100개, 사이트 5개, 사용자 20명, 1년 데이터 보존, 탄소 분석·이상탐지·AI 제어 포함. 초기 설치비 ₩500,000~. 연간 ₩2,990,000. 절감액 ≥ ₩900,000/월 예상.' },
                { role: 'Enterprise (₩790,000/월)', desc: '대기업·산업단지. 사이트·디바이스·사용자 무제한, 3년 데이터 보존, 전담 기술지원, SLA 보장, API 무제한, Big4 감사 대응 ESG 보고서. 초기 설치비 ₩1,500,000~. 절감액 ≥ ₩2,400,000/월 예상.' },
              ],
            },
            {
              type: 'warn',
              text: 'Trial 플랜은 IoT 하드웨어(게이트웨이·CT센서)가 지원되지 않습니다. 실시간 IoT 수집이 필요하면 Starter 이상으로 업그레이드하세요.',
            },
            {
              type: 'tip',
              text: '대시보드 > 절감 ROI 패널에서 현재 에너지 절감액과 구독료 대비 ROI 배수를 실시간으로 확인할 수 있습니다.',
            },
          ],
        },
        {
      ...
      articles: [
        {
          id: 'dashboard',
          title: '종합 모니터링 대시보드',
          description: '전력 사용량, 설비 상태, KPI, ROI를 실시간으로 확인합니다.',
          body: [
            { type: 'p', text: '메인 대시보드는 전체 사업장의 핵심 지표를 한 화면에 표시합니다.' },
            {
              type: 'list',
              items: [
                '상단 KPI: 연간 총 소비량(kWh), 현재 전력(kW), 일일 사용량, 전년 대비 증감',
                '에너지 네트워크 토폴로지 — 게이트웨이·사이트 연결 상태 실시간 시각화',
                '4개 게이지: 설비 가동률 / 에너지 효율 / DR 참여율 / 탄소 목표',
                '좌측 차트: 월별 소비·주간 추이·시간대별 부하·피크 분석',
                '우측 차트: 효율성 추이·비용 절감·탄소 배출량',
                '절감 ROI 패널: 월간 절감액·연간 ROI%·구독비 대비 절감 배수 실시간 표시',
                '실시간 현황: 현재 전력·일사용량·피크 대비·예상 요금·디바이스 상태',
              ],
            },
            {
              type: 'tip',
              text: '절감 ROI 패널은 KEPCO 요금 체계(피크 이전 + EMS 효율 8%)를 기반으로 절감액을 자동 계산합니다. 측정 데이터가 없으면 패널이 숨겨집니다.',
            },
          ],
        },
        {
        ...
        },
        {
          id: 'digital-twin',
          title: '디지털 트윈 (개발 예정)',
          description: '시설 3D 공간 모델과 실시간 IoT 데이터를 연동하는 디지털 트윈 기능 안내입니다.',
          body: [
            {
              type: 'p',
              text: '모니터링 > 디지털 트윈은 물리적 시설을 가상 공간에 1:1로 재현하여 실시간 IoT 데이터로 운영 최적화를 실현하는 기능입니다. 2026년 하반기 출시 예정이며 현재 미리보기 화면이 제공됩니다.',
            },
            {
              type: 'list',
              items: [
                '3D 시설 공간 모델링: 사이트 → 건물 → 층 → 구역 계층 구조',
                'IoT 센서 데이터와 공간 좌표 실시간 연동 (설비 노드 매핑)',
                'AI 기반 이상 징후 실시간 탐지 및 Z-score 시각화',
                '에너지 흐름 애니메이션 표현 (전력·열 흐름)',
                'BIM/CAD 도면 임포트 지원 (IFC 포맷)',
                '무선 센서 커버리지 맵 (Zigbee/LoRa 신호 강도)',
              ],
            },
            {
              type: 'tip',
              text: '디지털 트윈 출시 시 엔터프라이즈 플랜 고객에게 우선 제공됩니다. 알림 신청은 대시보드 > 디지털 트윈 미리보기 화면에서 가능합니다.',
            },
          ],
        },
        {
    ...
    // ══════════════════════════════════════════════
    {
      ...
      articles: [
        ...
        },
        {
          id: 'benchmark',
          title: '에너지 효율 벤치마킹',
          description: '같은 업종 평균 대비 에너지 원단위 순위와 절감 잠재량을 분석합니다.',
          body: [
            { type: 'p', text: '분석 > 벤치마킹에서 우리 사업장의 에너지 효율을 업종 전체 평균과 비교합니다.' },
            {
              type: 'list',
              items: [
                '에너지 원단위(kWh/m²/월) 계산 — 한국에너지공단 업종별 기준 비교',
                '에너지 등급: A+(상위 10%) ~ D(하위 25%) 자동 산정',
                '업종 내 백분위 순위 표시',
                '업종 평균 달성 시 월간 절감 잠재액 계산',
                '최근 6개월 원단위 추이 차트 — 업종 평균·최우수 기준선 포함',
                '항목별 비교 바차트 — 우리사업장 vs 업종평균 vs 최우수',
              ],
            },
            {
              type: 'list',
              items: [
                '지원 업종: 제조업 / 일반 건물 / 산업단지 / 데이터센터 / 기타',
              ],
            },
            {
              type: 'tip',
              text: '에너지 원단위 계산을 위해 관리 > 사이트 관리에서 사이트 면적(m²)을 등록하세요. 미등록 시 1,000m²로 가정하여 계산됩니다.',
            },
            {
              type: 'warn',
              text: 'IoT 게이트웨이 연결 전에는 측정 데이터가 없어 업종 평균 참고 수치만 표시됩니다. 실제 절감 잠재량은 데이터 수집 시작 후 제공됩니다.',
            },
          ],
        },
        {
          id: 'anomaly',
          title: '이상 탐지 (Business+)',
    ...
    // ══════════════════════════════════════════════
    {
      ...
      articles: [
        ...
        {
          id: 'notifications',
          title: '알림 설정 및 조치 가이드',
          description: '이메일, SMS 알림 규칙 설정 및 단계별 조치 가이드 기능입니다.',
          body: [
            ...
            {
              type: 'p',
              text: '알림 > 알림 현황 화면의 각 알림 항목 오른쪽에 "조치" 버튼이 표시됩니다.',
            },
            {
              type: 'list',
              items: [
                '전력 피크 초과 → 즉시 조치: 비필수 부하 차단 / DR 스케줄 확인 / ESS 방전 검토',
                '역률(PF) 저하 → 당일 조치: APFC 콘덴서 점검 / 역률 할증 방지 조치',
                '에너지 급증 → 당일 조치: 이상 설비 특정 / 생산량 대비 정상 여부 판단',
                '게이트웨이 오프라인 → 즉시 조치: 수집기 PC 전원·네트워크·방화벽 확인',
                '탄소 목표 도달 → 주내 조치: Scope별 원인 분석 / 크레딧 구매 검토',
              ],
            },
            {
              type: 'tip',
        ...
        },
        {
          ...
          body: [
            { type: 'p', text: '설정 > 구독 관리에서 현재 플랜과 결제 상태를 확인하고 업그레이드합니다.' },
            {
              type: 'list',
              items: [
                '현재 플랜: Trial(무료/30일) / Starter(₩99,000/월) / Business(₩299,000/월) / Enterprise(₩790,000/월)',
                '연간 결제: Starter ₩990,000 / Business ₩2,990,000 / Enterprise ₩7,900,000 (각 2개월 무료)',
                '결제 수단: 토스페이먼츠(국내 카드) 또는 Stripe(해외 카드/VISA/MasterCard)',
                '사용 현황: 사이트 수 / 디바이스 수 / 사용자 수 실시간 표시',
              ],
            },
            {
              type: 'p',
              text: 'IoT 하드웨어 초기 설치비(Starter ₩0 / Business ₩500,000~ / Enterprise ₩1,500,000~)는 구독과 별도로 청구됩니다.',
            },
            {
              type: 'list',
              items: [
                ...
                'ROI 시뮬레이션: 월 전기요금 입력 시 예상 절감액·회수기간 자동 계산 (가격 정책 페이지)',
              ],
            },
            {
              type: 'tip',
